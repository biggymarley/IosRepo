      ...
      <ScrollView>
        <View style={styles.cont}>
          ...
          <LottieView
            ...
            autoPlay={true}
            loop={true}
            style={{ height: windowWidth * 0.9, width: windowWidth }}
          />
        </View>
    ...
    <>
      ...
      {/* <View style={styles.section}>
        <Checkbox
          style={styles.checkbox}
          value={rules.rule}
          onValueChange={() => setrules({ ...rules, rule: !rules.rule })}
          color={rules.rule ? colors.text : undefined}
        />
        <Text style={styles.paragraph}>
          Ich möchte über anstehende Tourneen, Angebote und Termine für Fahren

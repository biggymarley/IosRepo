  ...
  return (
    <>
      ...
      <View style={{ flex: 1, padding: 15 }}>
        <LottieView source={locationLoading} autoPlay loop ref={ref} speed={1.5} />
        {/* <Text style={styles.title}>
          Es tu mir leid, es liegt aktuell kein Versandauftag von Ihnen vor
        </Text> */}
        {/* <TouchableOpacity
          style={styles.btn}
          onPress={() => navigation.navigate("History")}
        >
          <Text style={styles.btntxt}>Siehe Verlauf</Text>
        </TouchableOpacity> */}
      </View>
    </>
  );
